...
#
# DESCRIPTION:
#    marsgui(n): order dialog widget
#
#-------------------------------------------------------------------

namespace eval ::marsgui:: {
    namespace export order_dialog
}

#-----------------------------------------------------------------------
# Widget: order_dialog
#
# The order_dialog(n) widget creates order dialogs for orders defined
# using order(n).
#
# This module sends the <OrderEntry> event to indicate what kind of
# parameter is currently being entered.  Because order_dialog(n) works
# with a specific flunky used to enter the order, it will send the event
# as the flunky.
#
#-----------------------------------------------------------------------

snit::widget ::marsgui::order_dialog {
    #===================================================================
    # Dialog Management
    ...
    typemethod TopDialog {} {
        foreach w [lreverse [wm stackorder .]] {
            if {[winfo class $w] eq "Order_dialog"} {
                return $w
            }
        }
    ...
    component order      ;# The order(n) instance
